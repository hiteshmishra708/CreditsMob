...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SocialShared'
        db.create_table('app_socialshared', (
        ...
        db.send_create_signal('app', ['SocialShared'])

    def backwards(self, orm):
        # Deleting model 'SocialShared'
        db.delete_table('app_socialshared')
