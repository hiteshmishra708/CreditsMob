...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Rewards.code'
        db.add_column('app_rewards', 'code',
                      self.gf('django.db.models.fields.CharField')(default='abcde', max_length=250),
                      keep_default=False)

        # Adding field 'Rewards.reward_type'
        db.add_column('app_rewards', 'reward_type',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Rewards.code'
        db.delete_column('app_rewards', 'code')

        # Deleting field 'Rewards.reward_type'
        db.delete_column('app_rewards', 'reward_type')
